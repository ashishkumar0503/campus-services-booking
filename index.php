...
<body>
    ...
    <section id="booking">
        ...
        VALUES ('$service', '$timeSlot', '$paymentMethod', '$userName', '$userEmail', '$userPhone')";
            ...
            // Set PHP's SMTP server and port configuration
            ini_set("SMTP", $smtpServer);
            ini_set("smtp_port", $smtpPort);

            $headers = "From: kumarashish97713@gmail.com"; // Replace with your email address
    ...
    <div class="social-links">
        ...
        <p><i class="far fa-copyright"></i> Made By Ashish Kumar for PHP CA</p>
    </div>
